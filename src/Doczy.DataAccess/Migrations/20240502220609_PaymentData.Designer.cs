...
namespace Doczy.DataAccess.Migrations
{
    ...
    [Migration("20240502220609_PaymentData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Doczy.Core.Entities.CategorySlider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Doczy.Core.Entities.PayriffPayments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ApprovalCodeScr")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TranDateTime")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Doczy.Core.Entities.SocialMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Doczy.Core.Entities.Speciality", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Doczy.Core.Entities.UserSocialMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Doczy.Core.Entities.PayriffPayments", b =>
                {
                    b.HasOne("Doczy.Core.Entities.Appointment", "Appointment")
                        .WithMany()
            ...
            modelBuilder.Entity("Doczy.Core.Entities.UserSocialMedia", b =>
                {
                    b.HasOne("Doczy.Core.Entities.SocialMedia", "SocialMedia")
                        .WithMany()
                        .HasForeignKey("SocialMediaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Doczy.Core.Entities.Identities.DoctorAppUser", "User")
